...
# Only for busbar_IED
negation_dict = {}
matrix = final_xmldata["busbar_IED1"].matrix
no_of_cond = final_xmldata["busbar_IED1"].no_of_cond
negation_dict["busbar_IED1"] = form_negations("busbar_IED1", matrix, no_of_cond)
guard_list = negation_dict["busbar_IED1"].get_guard()
negation_dict["busbar_IED1"].make_negations(guard_list)
